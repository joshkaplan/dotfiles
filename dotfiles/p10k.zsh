# Generated by Powerlevel10k configuration wizard on 2020-10-08 at 22:09 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_DIRTY_ICON='\e729 '
  ...
  function my_git_formatter() {
    ...
    [[ -z $where ]] && res+="${(g::)POWERLEVEL9K_VCS_DIRTY_ICON}${clean}${VCS_STATUS_COMMIT[1,8]}"
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}\e727 ${VCS_STATUS_NUM_CONFLICTED}"
    ...
    VCS_STATUS_TOTAL_DIRTY=$(( VCS_STATUS_NUM_STAGED + VCS_STATUS_NUM_UNSTAGED + VCS_STATUS_NUM_UNTRACKED ))
    (( VCS_STATUS_TOTAL_DIRTY  )) && res+=" ${modified}±${VCS_STATUS_TOTAL_DIRTY}"
  ...
  # typeset -g POWERLEVEL9K_STATUS_OK_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=
...
#  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|amplify'
